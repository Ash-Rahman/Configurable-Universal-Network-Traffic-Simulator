...
def create_tcp_flow(number_of_flows):
    ...
    completed_flow_array = packet_list
    #wrpcap("test_pcap.pcap", completed_flow_array)
    print ("completed flow within create packet: \n"+ str(completed_flow_array))
...
'''
#main()
#wrpcap("incremental_length_test.pcap", packet_list)
